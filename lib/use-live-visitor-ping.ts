...
export type StorefrontEventType =
  ...
  // 4regn Oversized Premium Tees flash sale (price/cutoff change between
  // runs -- see FourRegnTeesSaleCountdown.tsx for the current numbers).
  // Simpler funnel than the flash cap's, since this promo has no claim/
