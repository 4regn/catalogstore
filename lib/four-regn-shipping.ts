...
export function buildCheckoutShippingOptions(
  ...
  // Premium product shipment is free -- R99 kept only as the struck-through
  // compare_at_price so the free delivery still reads as a real discount,
  // not just an absent line item. Direct instruction from the seller: it
  // was showing R99 original / R50 promo, and the promo price is meant to
  // be R0, not R50.
