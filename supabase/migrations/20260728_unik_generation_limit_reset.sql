-- Lowers the UNIK AI Studio daily generation cap back from the 1000
-- testing threshold (20260723_unik_generation_limit_testing.sql) to the
-- real production limit of 3 -- see the matching UI copy in
-- app/api/unik/account/route.ts and app/api/unik/generations/route.ts,
-- which also need to change together.
--
