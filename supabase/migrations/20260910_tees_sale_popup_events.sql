-- Adds the 2 Oversized Premium Tees popup event names (the homepage popup
-- shown once per session, 5s after landing) to store_visitor_events'
-- event_type check constraint, same "extends the existing list" pattern as
-- 20260830_tees_sale_analytics_events.sql and its own predecessors.
