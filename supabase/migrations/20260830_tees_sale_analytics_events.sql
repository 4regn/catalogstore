-- Adds the 4 Oversized Premium Tees flash sale event names to
-- store_visitor_events' event_type check constraint, same "extends the
-- existing list" pattern as 20260829_flash_cap_analytics_events.sql and
-- 20260830_wishlist_events.sql.
