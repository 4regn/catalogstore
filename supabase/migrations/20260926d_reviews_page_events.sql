-- Adds the 2 reviews-page event names to store_visitor_events' event_type
-- check constraint, same "extends the existing list, doesn't replace it"
-- pattern as every prior migration touching this constraint
-- (20260923c_checkout_funnel_events.sql, 20260829_flash_cap_analytics_events.sql,
-- etc.) -- without this, FourRegnStore.tsx/the reviews page's new
