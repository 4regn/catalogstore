            ...
            {showDcForm && (
              <div style={{ padding: "28px 24px", background: "var(--panel)", border: "1px solid var(--border)", borderRadius: 16, marginBottom: 24 }}>
                ...
                {dcShowCountdown && !dcExpires && (
                  <div style={{ padding: "12px 16px", background: "rgba(255,61,110,0.06)", border: "1px solid rgba(255,61,110,0.15)", borderRadius: 12, marginBottom: 16, fontSize: 12, color: "#ff3d6e" }}>Set an expiry date above — a countdown needs something to count down to. Without one, this code won't appear on your store at all.</div>
                )}
