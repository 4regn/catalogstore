...
const LightboxGallery = dynamic(() => import("./HeirloomLightbox"), { ssr: false });
              ...
              <div className="hl-foot-col">
                ...
                <div className="hl-pay-grid">
                  {seller.checkout_config?.payfast_enabled && (<>
                    ...
                    <span className="hl-pay-icon" title="Apple Pay"><svg width="28" height="14" viewBox="0 0 50 21"><path d="M9.4 2.2c-.6.7-1.5 1.3-2.5 1.2-.1-1 .4-2 .9-2.7C8.4.1 9.5-.4 10.4-.5c.1 1.1-.3 2.1-.9 2.7zm.9 1.4c-1.4-.1-2.6.8-3.2.8s-1.7-.8-2.8-.7C2.8 3.7 1.4 4.7.7 6.2c-1.4 2.7-.4 6.6 1 8.8.7 1 1.5 2.2 2.5 2.1 1-.1 1.4-.7 2.6-.7 1.2 0 1.5.7 2.6.6 1.1 0 1.8-1 2.5-2.1.8-1.2 1.1-2.3 1.1-2.4 0 0-2.2-.8-2.2-3.3 0-2.1 1.7-3 1.8-3.1-1-1.5-2.5-1.6-3.1-1.7z" fill="var(--ink)"/><path d="M21.8 1c3.4 0 5.7 2.3 5.7 5.8 0 3.4-2.4 5.8-5.8 5.8h-3.7v6h-2.8V1h6.6zm-3.8 9.3h3.1c2.3 0 3.6-1.3 3.6-3.5 0-2.2-1.3-3.5-3.6-3.5h-3.1v7zm11.2 4.5c0-2.2 1.7-3.6 4.7-3.7l3.5-.2v-1c0-1.4-1-2.2-2.5-2.2-1.5 0-2.4.7-2.6 1.8h-2.6c.1-2.4 2.1-4.1 5.3-4.1 3.1 0 5.1 1.6 5.1 4.2v8.8h-2.6v-2.1h-.1c-.8 1.4-2.3 2.3-4 2.3-2.4 0-4.1-1.5-4.1-3.8zm8.2-1.1v-1l-3.1.2c-1.6.1-2.4.8-2.4 1.8 0 1.1.9 1.8 2.3 1.8 1.8 0 3.2-1.2 3.2-2.8zm5 6.3v-2.2c.2 0 .6.1.9.1 1.3 0 2-.5 2.4-1.9l.3-.9L40 5.6h2.9l3.3 10.4h.1L49.5 5.6h2.8L47 18c-1.1 3.2-2.4 4.2-5.1 4.2-.3 0-.9 0-1.3-.1z" fill="var(--ink)"/></svg></span>
                    <span className="hl-pay-icon" title="Google Pay"><svg width="28" height="14" viewBox="0 0 40 16"><path d="M19.4 7.8v4.7h-1.5V1h3.9c1 0 1.8.3 2.5 1 .7.6 1 1.4 1 2.3 0 1-.3 1.7-1 2.3-.7.6-1.5.9-2.4.9h-2.5zm0-5.4v4h2.5c.6 0 1.1-.2 1.5-.6.4-.4.6-.9.6-1.4 0-.6-.2-1-.6-1.4-.4-.4-.9-.6-1.5-.6h-2.5zm10.8 2c1.1 0 2 .3 2.6.9.6.6 1 1.5 1 2.6v5.3h-1.4v-1.2h-.1c-.6 1-1.4 1.4-2.5 1.4-.9 0-1.7-.3-2.3-.8-.6-.5-.9-1.2-.9-2 0-.9.3-1.6 1-2.1.7-.5 1.6-.7 2.7-.7 1 0 1.8.2 2.3.5v-.4c0-.6-.2-1.1-.7-1.5-.4-.4-1-.6-1.6-.6-.9 0-1.6.4-2.1 1.2l-1.3-.8c.7-1.2 1.8-1.7 3.2-1.7zm-2 6.1c0 .5.2.8.6 1.1.4.3.8.4 1.3.4.7 0 1.4-.3 1.9-.8.5-.5.8-1.1.8-1.7-.5-.4-1.1-.6-2.1-.6-.7 0-1.3.2-1.7.5-.5.3-.8.7-.8 1.2zm11.4-5.8l-4.9 11.3h-1.5l1.8-4-3.2-7.3h1.6l2.3 5.5h0l2.2-5.5h1.6z" fill="var(--ink)"/></svg></span>
                  </>)}
