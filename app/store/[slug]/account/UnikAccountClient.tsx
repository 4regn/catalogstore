    ...
    <main className="ua-page">
      ...
      {!sessionReady ? <section className="ua-loading">Connecting your secure UNIK session…</section> : !signedIn ? (
        ...
        <section className="ua-dashboard">
          ...
          <a className="ua-kopa-entry" href="/private-templates/unik-labs/kopa.html?view=dashboard">
            <div><small>Kopa Payments</small><h2>Your flexible payment dashboard.</h2><p>Apply for a personal limit, follow Laybuy progress, manage repayments and reach live support.</p></div>
            <span>Open Kopa dashboard &rarr;</span>
          </a>
